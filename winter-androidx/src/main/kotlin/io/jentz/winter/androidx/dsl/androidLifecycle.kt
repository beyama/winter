...
/**
 * Registers an Android [androidx.lifecycle.LifecycleObserver] on the nearest [Lifecycle] and calls
 * the provided callbacks accordingly with the [io.jentz.winter.Graph] as receiver and [R] as
 * argument.
 *
 ...
 * @param onDestroy Called on [Lifecycle.Event.ON_DESTROY]
 */
inline fun <reified R: Any> SingletonService<R>.androidLifecycle(
    ...
    noinline onDestroy: GCallback<R>? = null
    ...
    val observer = object : DefaultLifecycleObserver {
        ...
        override fun onDestroy(owner: LifecycleOwner) {
            onDestroy?.let { it(instance) }
        }
    }

    val lifecycle: Lifecycle = instance()
